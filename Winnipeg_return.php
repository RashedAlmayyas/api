...
if (!$conn) {
   ...
   function formatAmount($value) {
    ...
    }$query = "SELECT * FROM WEB_SALES_TAX_INVOICE_VIEW WHERE COMP_NO=3 ORDER BY ID";
...
while ($invoice_data = oci_fetch_assoc($stid)) {
    ...
    $queryItems = "SELECT * FROM WEB_SALES_TAX_INVOICE_DTL_VIEW WHERE COMP_NO=3 AND HEADER_ID = :header_id";
...
//$itemName = $dom->createElement("cbc:Name", htmlspecialchars($item_data['ITEMNAME'], ENT_XML1 | ENT_COMPAT, 'UTF-8'));
    ...
    $clientId = "e13ea322-8867-44ba-abe3-9d03a97718cf";
    $secretKey = "";
...
oci_free_statement($stid5);  if (
            ...
            $db_success_message = "✅ تم تحديث حالة الفاتورة في قاعدة البيانات بنجاح.";
                ...
                $tempPngPath = '//192.168.0.7/Invoice/tax_Winnipeg/' . $invoiceId . '.png';
                $finalJpgPath = '//192.168.0.7/Invoice/tax_Winnipeg/' . $invoiceId . '.jpg';
